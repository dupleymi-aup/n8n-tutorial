...
- **Глоссарий** — всплывающие определения терминов (Workflow, Node, Trigger) + отдельный раздел-справочник с поиском
...
- **Поиск по FAQ** — фильтрация вопросов по ключевым словам и категориям
- **Глоссарий терминов** — отдельный раздел-справочник со всеми терминами n8n, поиск и фильтрация по категориям
- **Сочетания клавиш** — модальное окно справки (клавиша `?`) с перечнем горячих клавиш
- **Содержание страницы** — плавающая кнопка на мобильных для быстрой навигации по разделам
...
│   ├── layout.tsx                      # Root layout с ThemeProvider + JSON-LD
...
│       ├── glossary.tsx                # Глоссарий терминов с поиском
│       ├── newsletter.tsx              # Форма подписки с localStorage
│       ├── faq.tsx                     # FAQ (8 вопросов) с поиском
...
│       ├── shortcuts-help.tsx          # Справка по сочетаниям клавиш
│       ├── table-of-contents.tsx       # Содержание страницы (мобильное)
